...
void ARunnerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("Move Forward / Backward", this, &ARunnerCharacter::MoveForward);
	...
	PlayerInputComponent->BindAxis("Turn Right / Left Gamepad", this, &ARunnerCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("Look Up / Down Mouse", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("Look Up / Down Gamepad", this, &ARunnerCharacter::LookUpAtRate);
